...
import com.slalom.example.db.mongo.MongoRepository;
import com.slalom.example.db.sql.DataSourceSqlRepository;
...
//	private final UserRepository userRepository = new DataSourceSqlRepository();
	private final UserRepository userRepository = new MongoRepository();
